...
form.onsubmit = function(e) {
    ...
    if(timeArray.length == 4) {
        if((parseInt(calcTime(str)) >= timeArray[0]) && (parseInt(calcTime(str)) < timeArray[1])) {
            ...
            document.getElementById('text2').innerText = "TAKE SOME HEALTHY BREAKFAST!!!"
            document.getElementsByClassName("picture")[0].style.backgroundImage = "url(./wake_up.png)"
            ...
            document.getElementsByClassName("picture")[0].style.backgroundImage = "url(./partyTime.png)"
