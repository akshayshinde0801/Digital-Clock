...
function msg2(){
 ...
 if(hrr>=4 && hrr<12){
    document.getElementById("text2").innerHTML="Just know that you always bring out <br> the best in me. Good morning, sunshine!";
}
else if(hrr>=12 && hrr<16){
    document.getElementById("text2").innerHTML="What a beautiful day. Try to <br> leave work early to enjoy this wonderful day.";
}
else if(hrr>=16 && hrr<20){
    console.log("hello");
    document.getElementById("text2").innerHTML="Evenings are for relaxing with a cup of tea and <br> preparing yourself for tomorrow. Good evening buddy!";
}
else if(hrr>=20 || hrr<4){
    document.getElementById("text2").innerHTML="May the brightest stars twinkle upon your head <br> while you sleep tonight and may your life shine <br> when you wake up tomorrow. Have a good sleep!";
}
